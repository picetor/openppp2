    ...
    namespace net {
        namespace asio {
            ...
            AsyncSslvWebSocket::AsyncSslvWebSocket(
                ...
                : SslSocket(tcp_socket, ssl_context, ssl_websocket, verify_peer, host, sni, certificate_file, certificate_key_file, certificate_chain_file, certificate_key_password, ciphersuites)
                , path_(path)
                , sni_(sni)
