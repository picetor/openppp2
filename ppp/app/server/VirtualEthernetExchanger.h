...
namespace ppp {
    namespace app {
        namespace server {
            ...
            private:
                bool                                                                        DeleteTcpConnection(int connection_id) noexcept;
                bool                                                                        ForwardTcpConnection(const ITransmissionPtr& transmission, int connection_id, YieldContext& y) noexcept;
                bool                                                                        ReceiveTcpConnection(const std::shared_ptr<TcpConnection>& conn, int connection_id) noexcept;
            ...
            private:    
                ...
                TcpConnectionTable                                                          tcp_connections_;
