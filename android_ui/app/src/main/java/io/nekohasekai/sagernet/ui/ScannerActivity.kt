...
class ScannerActivity : ThemedActivity() {
    ...
    private suspend fun importResults(results: List<ProxyEntity>) {
        ...
        for (profile in results) {
            SagerDatabase.proxyDao.create(profile.apply {
                groupId = currentGroupId
                userOrder = SagerDatabase.proxyDao.nextOrder(currentGroupId) ?: 1
            })
        }
