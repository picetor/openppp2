...
| CI 工作流 | Debug 产物名 | 触发条件 |
|-----------|-------------|---------|
| `build-openppp2-amd64.yml` | `openppp2-linux-amd64-debug` | 与 Release 相同 |
| `build-openppp2-aarch64.yml` | `openppp2-linux-aarch64-debug` | 与 Release 相同 |
| `build-openppp2-macos.yml` | `openppp2-darwin-arm64-debug` + `openppp2-darwin-amd64-debug` | 与 Release 相同 |
| `build-openppp2-windows.yml` | `openppp2-windows-x64-debug` | 与 Release 相同 |
